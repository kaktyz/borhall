  ...
  (function (g, h, B) {
    ...
    function za(a, b) {
      ...
      if (.01 > Math.random()) try {
        var d = a && a.message || "";
        (c = -1 < d.indexOf("network error occurred") || -1 < d.indexOf("send beacon") && -1 < d.indexOf("Content Security Policy")) || (new Na).log("jserrs", ra, a.message, b, K.href, "", "string" === typeof a.stack && a.stack.replace(/\n/g, "\\n"))
      } catch (f) {}
    }
    ...
    function wb(a, b, c, d, f) {
      ...
      function x(a) {
        ...
        var Aa = a.nodeName.toUpperCase(),
          g = yb[Aa];
        g || (c |= 2);
        var r = n.getElementNeighborPosition(a);
        r || (c |= 4);
        ...
        var O = n.calcAttribChecksum(a);
        O && (d |= 2);
        a: {
          var w = n.getElementChildren(n.getElementParent(a),
            a.tagName);
          for (var h = 0; h < w.length; h++)
            if ((!w[h].id || "string" != typeof w[h].id) && n.calcAttribChecksum(w[h]) == O && n.calcTextChecksum(w[h]) == f) {
              w = !0;
              break a
            } w = !1
        }
      ...
      function H(a) {
        ...
        else(b = n.getElementParent(a)) && H(b), a[J] = Za, R[Za] = {}, Za++, b = x(a), va.append(b, void 0), b = C(a);
        va.append(b, void 0)
      }
        ...
        if (b && "SCROLLBAR" != b.nodeName) {
          if (/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b.tagName))
            if (b[J]) H(b);
              ...
              if (c) {
                c = c.elements;
                for (var d = c.length, f = 0; f < d; f++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(c[f].tagName) && !c[f][J] && H(c[f])
              } else H(b)
            }
          else H(b);
          G(t, [m.nowEventTime(), a.type, b, D.getPos(a), a.which, a.button])
        }
      }
      ...
      function A(a) {
        ...
        if (!(10 > c)) {
          var d = D.getPos(a),
            ...
            p = $a[1] - d[1];
          f = f * f + p * p;
          0 >= f || 16 > f && 100 > c || 20 > c && 256 > f || (jb = b, $a = d, I(a))
        }
      }
      ...
      function ba() {
        var a =
          n.getDocumentScroll(),
          b = m.nowTime();
        10 > b - kb || 10 > Math.abs(a[0] - ab[0]) && 10 > Math.abs(a[1] - ab[1]) || (kb = b, ab = a, G(Ba, [m.nowEventTime(), a]))
      }
      ...
      function aa(a) {
        if (a = D.getTarget(a)) {
          ...
          bb[a.localId] = c;
          a !== h && (H(a), G(Xa, [m.nowEventTime(), c, a]))
        }
      }

      function U() {
        G(v, [m.nowEventTime(), n.getViewportSize(), n.getDocumentSize()])
      }
      ...
      function ha(a) {
        return "INPUT" == a.tagName ? "password" == a.type || a.name && Oa.test(a.name) || a.id && Oa.test(a.id) : !1
      }
      ...
      function ia(a, b, c) {
        a = D.getTarget(a);
        var d = N(a);
        d.ignore || !d.forceRecord && (d.isPrivate && f.get("isEU") || M(a)) || (H(a), G(B, [m.nowEventTime(), b, c, a, d.privateFlag]))
      }
      ...
      function V() {
        ...
        if ("string" ==
          ...
          if (c) {
            a = N(c).privateFlag || M(c, !0);
            c = c.getElementsByTagName("*");
            for (var d = 0; d < c.length && !a;) a = N(c[d]).privateFlag || M(c[d], !0), d++;
            b != eb && (eb = b, b = a ? e.map(function () {
              return Ea.obfuscatedSymbol
            }, b.split("")).join("") : b, G(sa, [m.nowEventTime(), b]))
          }
        }
      }

      function Z() {
        fb || (fb = !0, eb && G(ta, [m.nowEventTime()]), e.setTimeout(function () {
          fb = !1
        }, 1, "wvl.copy"))
      }

      function X() {
        Fa || (Fa = !0, G(Ca, [m.nowEventTime()]))
      }

      function oa() {
        Fa && (Fa = !1, G(Bb, [m.nowEventTime()]))
      }
      ...
      function O(a) {
        if ((a = D.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)) {
          if (a[J]) H(a);
          else {
            var b = a.form;
            if (b) {
              b = b.elements;
              for (var c = b.length, d = 0; d < c; d++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[d].tagName) && !b[d][J] && H(b[d])
            } else H(a)
          }
          G(ua, [m.nowEventTime(), a])
        }
      }

      function w(a) {
        (a = D.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (H(a), G(F, [m.nowEventTime(), a]))
      }

      function W(a) {
        if ((a = D.getTarget(a)) &&
          !ha(a) && !M(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
          var b = N(a),
          ...
          H(a);
          G(y, [m.nowEventTime(), a, c, b.privateFlag])
        }
      }

      function L(a) {
        if ((a = D.getTarget(a)) && !S(a) && "FORM" == a.nodeName) {
          for (var b = a.elements, c = 0; c < b.length; c++) n.isEmptyField(b[c]) || H(b[c]);
          G(K, [m.nowEventTime(), a], !0)
        }
      }
      ...
      function Q(a) {
        ...
        if (a.touches && a.touches.length) {
          ...
          if (b && b != h) {
            H(b);
            for (var c = 0; c < a.touches.length; c++) G(t, [m.nowEventTime(), "touch", b, [a.touches[c].pageX, a.touches[c].pageY], 0, 0])
          }
        }
      }
      ...
      function da(a) {
        ...
        if (b) {
          ...
          c && (H(b), G(Ab, [m.nowEventTime(), b, D.getPos(a), c]))
        }
      }

      function pa(a) {
        (a = D.getTarget(a)) && "BODY" == a.tagName && va.append([], !0)
      }
      var va = new Pa({
          protocol: a,
          globalConfig: f,
      ...
      if (!e.isMetrikaPlayer()) {
        ...
        h.addEventListener ? (l.on(h, "scroll", aa), l.on(h, "focus", O), l.on(h, "blur", w), l.on(h, "change", W), l.on(h, "submit", L)) : h.attachEvent && (l.on(h, "focusin", O), l.on(h, "focusout", w), function () {
          for (var a =
      ...
      return {
        ...
        stop: function () {
          ...
          l.un(g,
            "blur", oa);
          l.un(h, "blur", oa);
          h.removeEventListener ? (l.un(h, "scroll", aa), l.un(h, "focus", O), l.un(h, "blur", w), l.un(h, "change", W), l.un(h, "submit", L)) : h.detachEvent && (l.un(h, "focusin", O), l.un(h, "focusout", w), function () {
        ...
        uploadPage: u(function (f) {
          ...
          if ("html" === f) return f = new RegExp("\x3cscript [^\x3e]*?//" + E.host.replace(/\./g, "\\\\.") + "/watch/.*?\x3c/script\x3e", "gi"), x.sendContent(n.getDocumentHTML().replace(f, ""), q, d, Ga, Ha), !0;
    ...
    function nb(a) {
      return Qa(a && a.innerHTML && a.innerHTML.replace(/<\/?[^>]+>/gi, ""))
    }
      ...
      var xa = function (a) {
        ...
        b.hash = function (a, b) {
          ...
          var q = a.length % 16,
            ...
            h = [0, b];
          b = [0, b];
          for (var r, l, T = [2277735313, 289559509], n = [1291169091, 658871167], m = 0; m < p; m += 16) r = [a.charCodeAt(m + 4) & 255 | (a.charCodeAt(m + 5) & 255) << 8 | (a.charCodeAt(m + 6) & 255) << 16 | (a.charCodeAt(m + 7) & 255) << 24, a.charCodeAt(m) & 255 | (a.charCodeAt(m + 1) & 255) << 8 | (a.charCodeAt(m +
            2) & 255) << 16 | (a.charCodeAt(m + 3) & 255) << 24], l = [a.charCodeAt(m + 12) & 255 | (a.charCodeAt(m + 13) & 255) << 8 | (a.charCodeAt(m + 14) & 255) << 16 | (a.charCodeAt(m + 15) & 255) << 24, a.charCodeAt(m + 8) & 255 | (a.charCodeAt(m + 9) & 255) << 8 | (a.charCodeAt(m + 10) & 255) << 16 | (a.charCodeAt(m + 11) & 255) << 24], r = c(r, T), r = f(r, 31), r = c(r, n), h = g(h, r), h = f(h, 27), h = d(h, b), h = d(c(h, [0, 5]), [0, 1390208809]), l = c(l, n), l = f(l, 33), l = c(l, T), b = g(b, l), b = f(b, 31), b = d(b, h), b = d(c(b, [0, 5]), [0, 944331445]);
          r = [0, 0];
          l = [0, 0];
          switch (q) {
            case 15:
            ...
            case 9:
              l = g(l, [0, a.charCodeAt(m + 8)]), l = c(l, n), l = f(l, 33), l = c(l, T), b = g(b, l);
            case 8:
              r = g(r, e([0, a.charCodeAt(m + 7)], 56));
            case 7:
              r = g(r, e([0, a.charCodeAt(m + 6)], 48));
            case 6:
              r = g(r, e([0, a.charCodeAt(m + 5)], 40));
            case 5:
              r = g(r, e([0, a.charCodeAt(m + 4)], 32));
            case 4:
              r = g(r, e([0, a.charCodeAt(m + 3)], 24));
            case 3:
              r = g(r, e([0, a.charCodeAt(m + 2)], 16));
            case 2:
              r = g(r, e([0, a.charCodeAt(m + 1)], 8));
            case 1:
              r = g(r, [0, a.charCodeAt(m)]), r = c(r, T), r = f(r, 31), r = c(r, n), h = g(h, r)
          }
          h = g(h, [0, a.length]);
          b = g(b, [0, a.length]);
          h = d(h, b);
    ...
    var l = C.inherit({
      ...
      on: function (a, b, c, d, f) {
        ...
        for (k = 0; k < e; k++) {
          ...
          p[p.length] = [a, h, c, d, f, r];
          a.addEventListener ? a.addEventListener(h, r, l._prepOpts(f)) : a.attachEvent && a.attachEvent("on" +
            h, r)
        }
      },
    ...
    l.supportsPassive =
      function () {
        if (l._supportsPassive !== B) return l._supportsPassive;
    ...
    var Ia = C.inherit({
        ...
        _initComponent: function () {
          ...
          this.storage && (a = this.storage.get(this.storageKey)) && a.data && a.meta && a.time && a.time +
            this.bufferExpireTime > +m.getMs() && this.onFlush.call(this.onFlushCtx || this, this.dataFromStorage(a.data), a.meta, a.pnum);
          this.clear()
        },
        ...
        append: function (a, b) {
          ...
          this.active && ((b || this.getFlushSize() >= this.maxBufferSize || this.getFlushSize() === this.maxChunkSize) && this._flush(b), this._flushTID || (this._flushTID =
            e.defer(this._flush, this.flushTimeout, this, [b], "DataBuffer._flush")))
        },
        activate: function () {
    ...
    var ya = C.inherit({
        ...
        send: function (a, b, c, d) {
          var f = [a],
            g = this,
            p = c || function () {};
          g.isDisabled() ? p.call(d) : function r(a) {
            if (a < this.transports.length) try {
              ...
              (function Ba(q) {
                q >= f.length ? c.blockNext() || r.call(this, a + 1) : c.request(f[q], b, function (a, b, c) {
              ...
              za(zb, "send by " + (c && c.id)), r.call(this, a + 1)
            }
          }.call(this, 0)
        }
      }),
    ...
    ha.stringify = function (a, b) {
      ...
      if (d.firstOrdering !== B)
        for (k = 0; k < b.firstOrdering.length; k++) f[b.firstOrdering[k]] =
          k;
      for (p in a)
    ...
    var V = C.inherit({
      ...
      qa = V.inherit({
        ...
        request: function (a, b, c, d) {
          var f = this,
            e;
          if (/[^a-z0-9.:-]/.test(K.host) && g.opera && "function" === typeof g.opera.version) {
    ...
    var Jb = V.inherit({
      ...
      index: 1,
      request: function (a, b, c, d) {
        "function" === typeof navigator.sendBeacon && !t.isAndroidWebView() && navigator.onLine ? (b = this._splitParams(b), b.get["force-urlencoded"] = 1, c.call(d, navigator.sendBeacon(this._buildUrl(a, b.get), ha.stringify(b.post)))) : c.call(d, !1)
      }
    });
    ...
    e.toJSON = function (a) {
      ...
      switch (a.constructor) {
        ...
        case Object:
          c = [];
          for (d in a) a.hasOwnProperty(d) && a[d] !== B && (c[c.length] = e.toJSON(d) + ":" + e.toJSON(a[d]));
          return "{" + c.join(",") + "}";
        default:
    ...
    var ma = {
        ...
        initPU: function (a, b) {
          var c = this;
          b.get("pu") !== B || this.checkVersion() || (this.globalConfig = b, b.setSafe("pu", null), a.addHandler("gpu-get", function () {
            return {
              type: "gpu-get",
              pu: b.get("pu")
            }
        ...
        initPP: u(function (a) {
          ...
          this.globalConfig = a;
          if (g.navigator.onLine && b && a.get("pp") == B && (this.globalConfig.setSafe("pp", null), b && b.prototype && b.prototype.constructor && b.prototype.constructor.name)) {
            try {
              var c = new b({
                iceServers: []
              });
        ...
        initZZ: function () {
          ...
          if (!this.getZZ() && !this.checkVersion()) {
            ...
            b.src = E.protocol + "//" + E.host + M.decode(E.cross);
    ...
    M.encode = function (a, b) {
      var c = (M.abc + (b ? M.tailSafe : M.tail)).split(""),
        d = a.length,
        f = [],
        g = d - d % 3,
        p;
    ...
    t.getSilverlightVersion = function () {
      if (!t._silverlightVersion)
        ...
        } catch (f) {} else if (b = g.navigator, b = b.plugins && b.plugins["Silverlight Plug-In"]) t._silverlightVersion =
          b.description;
    ...
    t.getFlashVersion = function () {
      if (!t._flashVersion) {
        ...
        if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
          ...
          if (c = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), b = c.GetVariable("$version")) t._flashVersion = b.split(" ")[1].replace(/,/g, ".").replace(/[^.\d]/g, "")
        } catch (d) {}
      }
    ...
    t.isDesktop =
      function (a) {
        var b = a.get("bt", {});
        a.get("bt") === B && (b.p = navigator.getBattery ? navigator.getBattery() : null, a.set("bt", b), b.p && b.p.then && b.p.then(function (a) {
    ...
    M.decode = function (a, b) {
      for (var c =
          M.abc + (b ? M.tailSafe : M.tail), d = 0, f = "", e, g, k, h, l; a.length % 4;) a += "\x3d";
      do {
    ...
    var na = P.inherit({
      ...
      _hitExt: function (a,
        ...
        if (!e.isMetrikaPlayer()) {
          var k = a.modes || {};
          var l = a.browserInfo || {};
          var r = "undefined" !== typeof a.referrer ? a.referrer : Ta.lastReferrer;
          var m = a.url || "";
          var n = {};
          a.nohit && c("nohit", 1);
          k.ar && !k.onlyData && (r = null === r || "" === r ? "" : this._prepareHitUrl(r), m = this._prepareHitUrl(a.url));
          c("forceNoRedirect", a.forceNoRedirect);
          c("page-ref", e.trim(r, Ja));
          c("page-url", e.trim(m, Ja));
          e.is4Bytes(a.title) && c("charset", "utf-8"); - 1 != z().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ?
          ...
          f && (m = e.toJSON(f), this.trimParams && m.length > Mb ? g = !0 : m > E.maxBodyLength ? e.warning("Too big params") : c("site-info",
            m));
          k.saveRef && (Ta.lastReferrer = r);
          h = function (a, b) {
            var c = {};
            e.forEachKey(b, function (a, b) {
              -1 === e.arrayIndexOf(["", 0, B, null], b) && (c[a] = b)
            });
            return e.mixin({}, a, c)
          }(h, {
      ...
      _getTechInfo: function (a, b, c, d, f, h, p, k, l, r) {
        function q(a, b, c) {
          var d = "" + b;
        ...
        d = d || m.getTimestamp();
        f = f || m.getTimezone();
        q("j", t.getJavaEnabled() ? "1" : "");
        var u = t.isDesktop(this.globalConfig);
        u !== B &&
          q("dp", u ? "1" : "0");
        q("nt", t.netType());
        q("ns", t.getNavigationStart());
        R && q("s", R.width + "x" + R.height + "x" + (R.colorDepth || R.pixelDepth));
        g.devicePixelRatio && q("sk", g.devicePixelRatio);
        t.isIframe() && (q("ifr", "1"), q("sti", t.isSameOriginTopFrame() ? "1" : "0"));
        g.ia_document && g.ia_document.shareURL && g.ia_document.referrer && q("iia", "1");
        q("adb", qb.getVal());
        q("f", t.getFlashVersion());
        q("l", t.getSilverlightVersion());
        q("fpr", t.getFingerPrint());
        ...
        q("la", t.getLanguage());
        q("ntf", t.getNotificationPermission());
        e.random(100) || q("np", M.encode(Sa.encode(e.trim(t.getPlatform(), 100))));
        h && q("wh", "1");
        ...
        f.isEnabled() && (c = f.getStorageId(), d = f.get("reqNum"),
          r || (d ? d++ : d = 1), f.set("reqNum", d), f.get("reqNum") == d ? (q("ls", c), q("rqn", d)) : (f.remove("reqNum"), f.clearStorageId(), 1 < d && (q("ls", c), q("rqn", 0))));
        q("rn", e.random());
        q("hid", p);
        r || 3 == this.counterId || b.pq || q("ds", Gb(l));
        l._firstPaint || r || (l._firstPaint = Ib(), q("fp", l._firstPaint));
        if (k) {
      ...
      _getTitle: function (a) {
        a = "undefined" == typeof a ? (a = n.getDocumentTitle()) ? e.trim(a, Ua) : "" : e.trim(a, Ua);
        return a
      }
    });
    ...
    var Ka =
      qa.inherit({
        ...
        _buildUrl: function (a, b) {
          b.wmode = 7;
          return Ka.superclass._buildUrl.apply(this, [a, b])
        },
        _parseResp: function (a) {
          var b = Y.parse(a);
          if (!b) throw "";
      ...
      hb = na.inherit({
          ...
          if (a) {
            a: {
              if (a = e.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/))
                if (a =
                  a[0].split("yandex").reverse()[0].substring(1), -1 != e.arrayIndexOf(E.yandexWhiteListTld, a)) break a;a = !1
            }
        ...
        sendHit: function (a) {
          ...
          c && (this._ilStorage.remove("il"), b.ilt = M.encode(Sa.encode(e.trim(c, sb))));
      ...
      La = C.inherit({
        ...
        hit: function (a, b) {
          ...
          !f && d && (f = this._cookie.read(this.KEY_NAME)) &&
            (f = Y.parse(f));
      ...
      tb = C.inherit({
        ...
        _initComponent: function () {
          ...
          this.syncTlds = e.reduce(function (a,
            c) {
            return c(a)
          }, E.yandexWhiteListTld, [e.bind(e.filter, null, function (b) {
            return b !== a.baseTld
        ...
        _sync: function (a, b) {
          ...
          if (0 < e) {
            ...
            for (c = 0; c < e; c++)(function (a) {
              l.request(f +
                (g._replaceBase[a] ? a : g.baseUrl + a) + "/sync_cookie_image_check", {},
                function (b) {
                  k();
                  var c = m.getMinutes();
                  b || (c -= 1435);
    ...
    var fa = {
      ...
      Pb = {
        ...
        _getHosts: function () {
          var a = [],
            b = K.protocol,
            c = t.isIOS();
          (t.isAndroid() || c && "http:" === b) && a.push(["https://web.archive.org/web/20190125194436/http://127.0.0.1", "30102"], ["https://web.archive.org/web/20190125194436/http://127.0.0.1", "29009"]);
          c && "https:" === b && a.push(["https://web.archive.org/web/20190125194436/https://yandexmetrica.com", "30103"], ["https://web.archive.org/web/20190125194436/https://yandexmetrica.com", "29010"]);
          return a
        },
      ...
      D = {
        ...
        getMouseButton: function (a) {
          return a.which || a.button == B ? a.which : a.button & 1 ? 1 : a.button & 2 ? 3 : a.button & 4 ? 2 : 0
        },
        prevent: function (a) {
          a = a || g.event;
    ...
    D.dispatchCustomEvent = u(function (a, b) {
      var c;
      b = b || h;
      if (c = e.getNativeFunction("createEvent",
          h)("Event")) c.initEvent(a, !1, !1), e.getNativeFunction("dispatchEvent", b)(c)
    }, "evt.dispatch");
    var Ta = {
        lastReferrer: null
      },
      ia = C.inherit({
        ...
        initUserLayer: function () {
          ...
          if (this.prefsEcommerce || this.prefsUseDataLayer) this._overridePush(this.prefsEcommerce) || (e.isString(this.prefsEcommerce) && (this.dataLayerName = this.prefsEcommerce), a = this.dataLayerName, this._tryTimeout = e.bind(this._tryTimeout,
    ...
    var Qb = {
        ...
        addAsyncItem: function (a, b, c, d, f) {
          ...
          c ? (clearTimeout(this.timeout), g.flushAsync(!0)) :
            m.getMs() - this.rest >= this.restTime && !this.timeout ? (this.rest = m.getMs(), g.flushAsync()) : this.timeout || (this.timeout = e.setTimeout(function () {
              g.rest = m.getMs();
              g.flushAsync();
              g.timeout = !1
            }, this.restTime))
        ...
        chain: function (a, b, c, d) {
          ...
          (function r(b, c, e) {
            f.addAsyncItem(function (b, c, d) {
              c = a[b++](c);
              b <= a.length - 1 && r(b, c, d)
            }, null, e, [b, c], d + "." + b)
          })(0, b, c)
        },
        callByTimeout: function (a, b) {
          for (var c = m.getMs(), d = 0, f, g = (b || 0) + 1, h = 0,
              k = this; this.asyncBuffer.length;)
      ...
      Rb = ["https://web.archive.org/web/20190125194436/https://brozen.yandex.ru", "https://web.archive.org/web/20190125194436/https://yabro1.zen-test.yandex.ru/yabro/index.html", "https://web.archive.org/web/20190125194436/https://yabro2.zen-test.yandex.ru/yabro/index.html"],
      aa = C.inherit({
        globalKey: "f1",
        MAX_SIZE: 1E6,
        isYAN: !1,
        ...
        showPopup: function (a, b, c, d, f) {
          var e = this;
          a = n.loadScript({
            src: "https://web.archive.org/web/20190125194436/https://yastatic.net/q/global-notifications/cc/_lego-cc" + a + "." + b + ".js"
          });
        ...
        handle: function () {
          var a = this._sender,
            b = [],
            c = (t.getLanguage() || "").toLowerCase().split("-")[0],
          ...
          if (!this.enabled && ("0" === h || t.isSafariWebView() || t.isAndroidWebView() ||
              e.inArray(Rb, g.location.href.split("?")[0]) || !ea() || f.read("yandex_login") || this.disable)) return f.read("yandex_login") ? this.trigger("GDPR-skip-login") : ea() ? "0" === h ? this.trigger("GDPR-skip") : t.isSafariWebView() || t.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"), this.realise(r, b);
          ...
          a.hit(function (a) {
            if (a.params.eu || l || k.enabled)
              ...
              } else k.askGDPR(h, d, c, r, b, f);
            else return a.params.eu ? k.trigger("GDPR-skip-eu-na") : k.trigger("GDPR-eu-skip"), k.realise(r, b)
          })
        }
      });
    aa.globalKey = "f1";
    ...
    aa.getState = function (a) {
      ...
      return a.length ?
        (a = a.join(","), b && (a += "-" + (e.inArray(["0", "1"], b) ? b : "2")), a) : ""
    };
    var Sb = {
      init: function (a, b) {
        var c = h.createElement("img");
        a && a.account && a.tmsec && b && (c.src = "https://web.archive.org/web/20190125194436/https://www.tns-counter.ru/V13a****" + a.account + "/ru/UTF-8/tmsec\x3d" + a.tmsec + "/" + b)
      }
    };
    t.isIE = function () {
    ...
    t.isPrivate = u(function (a) {
      ...
      if (t.isFF()) try {
        ...
        b()
      } else if (t.isSafari() && e.isFunction(g.openDatabase)) try {
    ...
    var Tb = P.inherit({
      ...
      Ma = C.inherit({
        injectHash: {
          Wjw75ghm7fa7JW8p: "https://web.archive.org/web/20190125194436/https://yastatic.net/metrika-static-watch/assessor-init.js",
          Z4RhWJNDJanzkGJa: "https://web.archive.org/web/20190125194436/https://yastatic.net/metrika-static-watch/assessor-compare.js"
        },
          ...
          b.detectAd = function () {
            ...
            ta.forEach(function (d) {
              ...
              var l = e + k,
                ...
                n = 0 > e ? 0 : e < q ? e : q,
                r = 0 > g ? 0 : g < p ? g : p;
              100 <= ((l > q ? q : l > n ? l : n) - n) * ((m > p ? p : m > r ? m : r) - r) && v.push({
                top: g,
                left: e,
                width: k,
                height: f,
      ...
      return u(function () {
        ...
        function E(a, b) {
          ...
          d && (d = -1 < d.indexOf(";") ? e.safeDecodeURIComponent(d) :
            Sa.decode(M.decode(d.replace(/[-*_]/g, function (a) {
              return {
                "*": "+",
                "-": "/",
                _: "\x3d"
        ...
        function x() {
          var m = !1;
          Qa || (P.initCookie(), qb.init(v));
          ma.initPU(ja, v);
          t.isAndroidWebView() || ma.initPP(v);
          P.retransmit(v);
          za && Sb.init(za, ca);
          Ua.init(ya);
          if (v.get("hitParam")[U]) {
            ...
            var w = function (w) {
              ...
              m.sendHit({
                ...
                callback: function (m, O) {
                  ...
                  m = m || {};
                  (n = "0" !== m.pcs) || ma.initZZ();
                  m.eu !== B && v.set("isEU", m.eu);
                  fa.init(O);
                  Vb.match();
                  Pb.sync(a, c, n, v);
                  S.log("PageView. Counter ", a, ". URL: ", K.href, ". Referrer: " + h.referrer, ". Params: ", b);
                  Wa || (Wa = +new Date);
                        ...
                        if (t && t.length)
                          for (W = 0; W < t.length; W++) {
                            ...
                            if ("ref" == L.type) L = q(L);
                              ...
                              var x = Q.ServiceNamePattern;
                              var y = Q.RefererPattern;
                              L = da ? Q.direct_orders : Q.direct_camp;
                              var z = h.referrer,
                                C = ha.parse(K.search),
                                pa = E(K.search, K.hash),
                                D = {};
                              var A = ["source", "medium", "campaign", "term", "content"];
                              for (u = 0; u < A.length; u++) C["utm_" + A[u]] && (D[A[u]] = C["utm_" + A[u]]);
                              var I = da ? "direct.yandex.ru" : pa && pa.service || D.source;
                              u = !1;
                              if (!u && x && x.length)
                                for (A = 0; A < x.length; A++)
                                  if ((new RegExp(x[A], "i")).test(I)) {
                                    u = !0;
                                    break
                                  } if (!u && !Q.yandex_direct && y && y.length)
                                for (x = 0; x < y.length; x++)
                                  if ((new RegExp(y[x], "i")).test(z)) {
                                    u = !0;
                                    break
                                  }! u && Q.google_adwords && C.gclid && (u = !0);
                              if (u && L && L.length && (u = !1, da = da || pa && pa.campaign || D && D.campaign))
                            ...
                            if (L) {
                              t[W].track_id && n.create("mp2_track", t[W].track_id, 43200);
                              break b
                            }
                          }
                      }
                      t = n.read("mp2_track");r = r.substs && r.substs[t];t && r ? (n.create("mp2_substs", e.toJSON(r)), n = p(r), f.params("__ym", n ? "mp_trackid" : "mp_trackid_bad", t)) : k()
                    }
                    else k();
          ...
          R(!1);
          l.on(h, "click", X);
          0 != e.keys(y).length && (Ma && Ma.initUserLayer(), y.enableAll ? (R(!0), V(!0), sa()) : (y.clickmap && V(y.clickmap), y.trackLinks && R(y.trackLinks), y.accurateTrackBounce &&
            sa(y.accurateTrackBounce)), y.triggerEvent && e.async(function () {
            D.dispatchCustomEvent("yacounter" + a + "inited")
          }, this, "yacounterInit"))
        }
        ...
        function ea(a) {
          ...
          if (c) {
            ...
            if (vb.test(f) || vb.test(c) || ob(c, ka) || ob(f, ka)) d = !0;
            f = n.classNameExists(b, "ym-disable-tracklink");
            var h = n.classNameExists(b, "ym-external-link");
            f || (a = e.mixin(a, {
              ln: !0,
              dl: d
            }), h ? g(a) : (h = b.hostname || e.parseUrl(b.href).hostname || "", f = y.url ? e.parseUrl(A).hostname : z().hostname, Eb(f, h) ? d ? (a.ln = !1, g(a)) : (d = nb(b), Ka.set("pai", a.pai),
              d && d != c && Ka.set("il", e.trim(d, sb))) : c && -1 != c.search(/^ *(data|javascript):/i) || (a.ut = gb, g(a))))
          }
        }
        ...
        function ra(a, b) {
          ...
          var k = !1,
            ...
            O = null,
            q = !1;
          if (t.isIE()) e.setTimeout(a, b, "trackUserTime");
          else {
        ...
        function ta(a) {
          ...
          (function Q() {
            ...
            d !== c &&
              (a(), c = d);
            La = e.setTimeout(Q, 200, "trackHash")
          })()
        }

        function Ca(a) {
          if (!1 === a) Z && ("onhashchange" in g ? l.un(g, "hashchange", qa) : e.clearTimeout(La), Z = !1);
          else if (a = qa, !Z) {
        ...
        if (!g["disableYaCounter" + a]) {
          ...
          var Ua = {
            init: function (a, b) {
              if (g.performance && "function" === typeof performance.getEntries && (a === B && (a = 1), !(Math.random() >= a))) {
                var c = {
                    1882689622: 1,
                    2318205080: 1,
                    3115871109: 1,
                ...
                e.keys(l).length && (new Na(k)).logParams(l)
              }
            }
          };
          ya = 24226447 == a ? 1 : .002;
          f.replacePhones = r(function () {
            var b, c;
            try {
              (b = (new F({
                counterId: a
          ...
          f.reachGoal = r(function (b, c, d, e) {
            2 <= arguments.length && "function" === typeof c && (e = d, d = c, c = B);
          ...
          f.hit = r(function (b, c, d, g, h, k) {
            b ? (e.isObject(c) && (d = c.referer, g = c.params, h = c.callback, k = c.ctx, c = c.title), A = b, S.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " +
              d, ". Params: ", g), N.sendHit({
              url: b,
              title: c,
              hasPrerender: G,
              referrer: d,
              ...
              callback: h,
              ctx: k
            }), G = !1) : e.warning("Empty hit url");
            return f
          }, "counter.hit");
          f.params = r(function (b) {
            ...
            if (b) {
              ...
              N.sendParams(g[0], h, k, y.url ? A : z().href)
          ...
          f.file = r(function (a, b) {
            a ? (b = b || {}, N.sendFileUpload({
              ...
              callback: b.callback,
              ctx: b.ctx,
              referrer: y.url ? A : z().href
            })) : e.warning("Empty file url");
            return f
          }, "counter.file");
          f.extLink = r(function (a, b) {
            a ? (b = b || {}, N.sendExtLink({
              url: a,
              title: b.title,
              vParams: b.params,
              ...
              ctx: b.ctx,
              referrer: y.url ? A : z().href
            }, A)) : e.warning("Empty link");
            return f
          }, "counter.extLink");
          f.notBounce = r(function (a) {
            var b = 0;
            a = a || {};
            ib && Wa && (b = Wa - ib);
            N.sendNotBounce(b, {
          ...
          var ka = [];
          f.addFileExtension = r(function (a) {
          ...
          f.accurateTrackBounce = r(function (a) {
            sa(a);
            return f
          });
          var La = null;
          var Z = !1;
          f.trackHash = r(function (a) {
            Ca(a);
            return f
          });
          var Va = {
          ...
          f.ecommerceDetail = r(function (a, b) {
            ua("detail", a, b);
            return f
          }, "ecommerce.detail");
          f.ecommerceAdd = r(function (a, b) {
            ua("add", a, b);
            return f
          }, "ecommerce.add");
          f.ecommerceRemove =
          ...
          f.ecommercePurchase = r(function (a, b) {
            ua("purchase", a, b);
            return f
          }, "ecommerce.purchase");
          f.userParams = r(function (a, b, c) {
            e.isObject(a) ? f.params({
              __ymu: a
            }, b || function () {}, c) : e.warning("Wrong user params");
            return f
          }, "uparams");
          f.experiments = r(function (a, b, c) {
            N.sendExperiments({
              callback: b,
              ctx: c,
              experiments: a
          ...
          f.id = f.setUserID = r(function (a, b, c) {
          ...
          if (a) {
            ...
            if ("prerender" === h.webkitVisibilityState || "prerender" === h.visibilityState) {
              ...
              var lb = function () {
                "prerender" !== h.webkitVisibilityState && "prerender" !== h.visibilityState && (l.un(h, "webkitvisibilitychange,visibilitychange", lb), C(!0))
              };
              l.on(h, "webkitvisibilitychange,visibilitychange",
                lb)
            } else C(!1)
          }
        }
    ...
    g.Ya.Metrika.informer = function (a) {
      ...
      b || n.loadScript({
        src: "https://web.archive.org/web/20190125194436/https://informer.yandex.ru/metrika/informer.js"
      })
    };
...
/*
     FILE ARCHIVED ON 19:44:36 Jan 25, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:52:24 Nov 03, 2020.
...
/*
playback timings (ms):
  LoadShardBlock: 1045.372 (6)
  exclusion.robots: 0.206
  esindex: 0.017
  PetaboxLoader3.resolve: 313.275 (2)
  CDXLines.iter: 138.962 (3)
  PetaboxLoader3.datanode: 969.916 (8)
  load_resource: 878.247 (2)
  RedisCDXSource: 43.96
