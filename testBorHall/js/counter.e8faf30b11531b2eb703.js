  ...
  atwpjp([220, 219], {
      ...
      t.exports = {
        facebook: {
          cb: function (t) {
            var e = t.params,
              a = t.data;
            _ate.ed.fire("addthis-internal.fbsharecount", {}, t.data), a.share ? t.callbackFunc({
              elem: e.elem,
              service: e.service,
              countUrl: e.countUrl,
              count: n(a.share.share_count) ? a.share.share_count : 0
            }) : t.callbackFunc({
              elem: e.elem,
              service: e.service,
              countUrl: e.countUrl,
          ...
          baseUrl: "//web.archive.org/web/20190125195441/https://graph.facebook.com/?id="
        },
        pinterest_share: {
          baseUrl: "//web.archive.org/web/20190125195441/https://widgets.pinterest.com/v1/urls/count.json?url="
        },
        pinterest: {
          baseUrl: "//web.archive.org/web/20190125195441/https://widgets.pinterest.com/v1/urls/count.json?url="
        },
        reddit: {
          cb: function (t) {
            var e, a = t.params,
              ...
              o = 0,
              s = 0;
            if (i.data && i.data.children) {
              e = i.data.children;
              for (var d in e) {
                var c = e[d];
                e.hasOwnProperty(d) && c.data && void 0 !== c.data.downs && void 0 !== c.data.ups && (r += c.data.ups, o += c.data.downs, s += c.data.score)
              }
              t.callbackFunc({
                elem: a.elem,
                service: a.service,
          ...
          baseUrl: "//web.archive.org/web/20190125195441/https://www.reddit.com/api/info.json?url=",
          jsonpParam: "jsonp"
        },
        vk: {
          ajs: function (t) {
          ...
          baseUrl: "//web.archive.org/web/20190125195441/https://vk.com/share.php?act=count&index="
        },
        linkedin: {
          ajs: function (t) {
            var e = t.params,
            ...
            }, _ate.ajs(this.baseUrl + encodeURIComponent(e.countUrl) + "&" + this.jsonpParam + "=" + a, 1)
          },
          baseUrl: "//web.archive.org/web/20190125195441/https://www.linkedin.com/countserv/count/share?url="
        },
        odnoklassniki_ru: {
          ajs: function (t) {
            var e = t.params;
          ...
          baseUrl: "//web.archive.org/web/20190125195441/https://www.odnoklassniki.ru/dk?st.cmd=extLike&uid="
        },
        addthis: {
          baseUrl: "//web.archive.org/web/20190125195441/https://api-public.addthis.com/url/shares.json?url="
        },
        compact: {
          baseUrl: "//web.archive.org/web/20190125195441/https://api-public.addthis.com/url/shares.json?url="
        },
    ...
    815: function (t, e) {
      ...
      e.__esModule = !0, e.default = function (t, e) {
        ...
        for (var a = "", n = 0; n < t; n++) a += e.charAt(Math.floor(Math.random() * e.length));
        return a
      }, t.exports = e.default
    },
    816: function (t, e, a) {
      ...
      e.default = function (t, e, a, n) {
        var i = [];
        i.push(e), "https" === e.substring(0, 5) ? i.push(e.replace("https", "http")) : "http" === e.substring(0, 4) && i.push(e.replace("http", "https")), d.string(t) && (t = [t]), d.array(t) && ! function () {
          var e = [],
            o = {},
            d = 0,
            l = function (n) {
              if (d++, o[n.service] ? "compact" !== n.service && "odnoklassniki_ru" !== n.service && (o[n.service].countUrl2 || n.countUrl === o[n.service].countUrl || (o[n.service].count += n.count, o[n.service].countUrl2 = n.countUrl)) : (e.push(n), o[n.service] = n), d === t.length * i.length) {
                var r = a.bind(this, e);
                setTimeout(r, 0)
              }
            };
          i.forEach(function (e) {
            if (c.combCounts) s.default({
              ...
              for (var a = 0; a < t.length; a++) r.default({
                elem: n,
                countUrl: e,
                service: t[a]
              }, l)
    ...
    817: function (t, e, a) {
      ...
      e.default = function (t, e) {
        ...
        if (n.jsonpParam = n.jsonpParam || i.jsonpParam || "callback", h === o.PENDING_RESPONSE) c.putCallback(a, u, e);
        else if (h === o.RESPONDED) s({
          params: t,
          data: c.getResponse(a, u),
          callbackFunc: e
        });
          ...
          var f = function (e) {
              ...
              }), c.putResponse(a, u, e), c.clearCallbacks(a, u), c.putStatus(a, u, o.RESPONDED), clearTimeout(p)
            },
            _ = "pinterest_share" === t.service || "pinterest" === t.service,
            b = Math.floor(999999 * Math.random()).toString(36),
            m = (_ ? "window." : "") + _ate.util.scb("rcb", b, f);
          l.call(n, {
            params: t,
            callbackFunc: e,
            jsonpCallbackFunc: f,
            cbname: m,
            timeout: p
          }), c.putStatus(a, u, o.PENDING_RESPONSE), c.putCallback(a, u, e), d.increment()
        }
      }, t.exports = e.default
    },
    818: function (t, e, a) {
      ...
      var p = function () {
        function t() {
          i(this, t), this._statusMap = new s.default, this._responseMap = new s.default, this._callbackMap = new s.default
        }
        ...
        }, t.prototype.putStatus = function (t, e, a) {
          r(t, e), this._statusMap.put(t, e, a)
        }, t.prototype.putResponse = function (t, e, a) {
          r(t, e), this._statusMap.put(t, e, u), this._responseMap.put(t, e, a)
        }, t.prototype.putCallback = function (t, e, a) {
          r(t, e);
    ...
    820: function (t, e, a) {
      ...
      function i(t, e, a) {
        ...
        n.forEach(function (t) {
          return t(a)
        }), h.putResponse(t, e, a), h.clearCallbacks(t, e), h.putStatus(t, e, r.RESPONDED)
      }
      e.__esModule = !0;
      var r = a(818),
        o = n(r),
      ...
      e.default = function (t, e) {
        ...
        if (n.forEach(function (t) {
            ...
            d === r.PENDING_RESPONSE ? h.putCallback(i, o, e) : d === r.RESPONDED ? e(h.getResponse(i, o)) : d === r.NOT_REQUESTED && (h.putStatus(i, o, r.PENDING_RESPONSE), h.putCallback(i, o, e), s.push({
              service: t,
              cacheKey: i,
              endpointKey: n
            }), c.push(n))
          ...
          var _ = function () {
            ...
            b = function (t) {
              s.forEach(function (e) {
                ...
                d.default(n) ? r.count = t[e.endpointKey] : (r.count = 0, r.error = "Service request failed on the server"), i(e.cacheKey, o, r)
              })
            };
          c.sort();
          var m = c.join() + o,
            g = _ate.util.scb("rcb", m, b, _, !0);
          _ate.ajs("//web.archive.org/web/20190125195441/https://api-public.addthis.com/url/serviceapi/shares.json?services=" + encodeURIComponent(c.join(",")) + "&url=" + encodeURIComponent(o) + "&pubId=" + encodeURIComponent(l.default()) + "&callback=" + g, 1), u.increment()
        }
      }, t.exports = e.default
    },
    896: function (t, e, a) {
      ! function () {
        function t(t, e, a) {
          return t /= e, t = Math.round(10 * t) / 10, (t + "").length > 4 && (t = Math.round(t)), t + a
        }

        function e(e) {
          var a = ("" + e).split(".").shift().length;
          return isNaN(e) ? e : a < 4 ? Math.round(e) : a < 7 ? t(e, 1e3, "K") : a < 10 ? t(e, 1e6, "M") : t(e, 1e9, "B")
        }
        ...
        function o(t, e) {
          var a, r = _ate.cookie.rck("_atshc");
          r && (r = n(r), a = (r || {})[t] || 0, a && e >= a && (delete r[t], _ate.cookie.sck("_atshc", i(r), 1, 1)))
        }

        function s(t) {
          var a = _ate.cookie.rck("_atshc"),
            r = d(t) + 1;
          t.shares = r, c(t, e(r)), a = a ? n(a) : {}, a[t.url] && delete a[t.url], A[t.url] = a[t.url] = r, _ate.cookie.sck("_atshc", i(a), 1, 1)
        }
        ...
        function c(t, e) {
          if (t) {
            var n = t.className.indexOf("pill_style") > -1,
              ...
              s = t.addthis_share || {},
              d = o && o.product;
            if (t.firstChild && 3 == t.firstChild.nodeType && t.removeChild(t.firstChild), r) {
              var c = x.ce("a"),
                l = x.ce("a"),
                u = x.ce("span"),
                h = a(65),
        ...
        function u(t, e, a, n) {
          var i = 0,
            s = r(t.url);
          i = e.error ? "?" : e.shares, !isNaN(s) && (isNaN(i) && s > 0 || s > i) ? i = s : o(t.url, i), A[t.url] || (A[t.url] = i), n ? a(t, e) : a(t, i)
        }
        ...
        function h(t, e) {
          ...
          var a = t,
            n = _ate.util.scb("sc", t, function (a) {
              if (g) {
                var i = (new Date).getTime() - _ate.util.getCallbackCallTime(n),
                  r = new Image;
                r.src = "//web.archive.org/web/20190125195441/https://m.addthisedge.com/live/t00/mu.gif?a=sc&r=" + 1 / g + "&" + (isNaN(i) ? "err=1" : "t=" + i)
              }
              a.url || (a.url = t), y[t] = a, e(y[t])
            }, function () {
              y[t] = {
                error: {
          ...
          a = v.util.gUD(t).toLowerCase() + v.util.gUQS(t), _ate.ajs("//web.archive.org/web/20190125195441/https://api-public.addthis.com/url/shares.json?url=" + _euc(a) + "&callback=" + n, 1)
        }

        function p(t, e, a) {
          var n = r(t.url),
            i = t.url;
          if (w[i] || (w[i] = []), w[i].push(t), _ate.ed.addEventListener("addthis.menu.share", function (e) {
              try {
                if (e.data.service && _ate.track.mgu(e.data.url, {
                    clean: 1,
                    defrag: 1
                  }) == i) {
                  if ("facebook_unlike" == e.data.service || "more" == e.data.service || "email" == e.data.service || "google_unplusone" == e.data.service) return;
                  s(t)
                }
              } catch (t) {}
            }), void 0 !== A[i]) e(t, A[i]);
          else if (i) {
            if (!isNaN(n) && n > 0 && e(t, n), _ate.track.apc("sco" + (t.className.indexOf("pill_style") > -1 ? "pl" : "") + "-300"), w[i].length > 1) return;
            h(i, function (t) {
              if (t && !t.error && t.shares && (A[i] = t.shares), w[i])
                for (var a = 0; a < w[i].length; a++) u(w[i][a], t, e)
            })
          }
        }
        ...
        function f(t, a, n) {
          if (t) {
            ...
            for (var i = 0; i < t.length; i++) {
              var r = t[i],
                o = ((r.parentNode || {}).className || "").indexOf("addthis_toolbox") > -1 ? addthis.util.getAttributes(r.parentNode, a, n) : (((r.parentNode || {}).parentNode || {}).className || "").indexOf("addthis_toolbox") > -1 ? addthis.util.getAttributes(r.parentNode.parentNode, a, n) : null,
                s = addthis.util.getAttributes(r, o ? o.conf : a, o ? o.share : n, !0);
              if (!r.ost)
                if (r.className.indexOf("addthis_counter") == -1 && (r.className += " addthis_counter"), r.url = (n || s.share || k.addthis_share || {}).trackurl || _ate.track.mgu((n || {}).url || s.share.url || (k.addthis_share || {}).url, {
                    clean: 1,
                    defrag: 1
                  }), r.addthis_conf = s.conf, r.addthis_share = s.share, r.ost = 1, s.conf && s.conf.service) {
                  var d = _ate.util.parent(r, ".addthis_toolbox"),
                    u = null != d.className ? d.className.indexOf("addthis_floating_style") !== -1 : "",
                    h = null != d.className ? d.className.indexOf("native-counter") !== -1 : "";
                  u && !h && (d.className += " native-counter"), N.getCounts(s.conf.service, r.url, function (t) {
                    c(t[0].elem, e(t[0].count))
                  }, r)
                } else p(r, function (t, e) {
                  l(t, e)
                })
            }
          }
        ...
        function b(t, e, a) {
          if (t) {
            ...
            for (var n = 0; n < t.length; n++) {
              var i = t[n],
                r = ((i.parentNode || {}).className || "").indexOf("addthis_toolbox") > -1 ? addthis.util.getAttributes(i.parentNode, e, a) : null,
                o = addthis.util.getAttributes(i, r ? r.conf : e, r ? r.share : a, !0);
              i.ost || (i.url = (a || o.share || k.addthis_share || {}).trackurl || _ate.track.mgu((a || {}).url || o.share.url || (k.addthis_share || {}).url, {
                clean: 1,
                defrag: 1
              }), i.addthis_conf = o.conf, i.addthis_share = o.share, i.ost = 1, h(i.url, function (t) {
        ...
        function m() {
          addthis.count = b, addthis.counter = _, addthis.sharecounters = U, addthis.data.getShareCount = function (t, e) {
            e || (e = addthis_share), h("string" == typeof e ? e : e.trackurl || e.url, t)
          }, addthis.count.ost = 1, addthis.counter.ost = 1, addthis.sharecounters.ost = 1
        }
        var g = Math.random() < _atc.famp,
          ...
          U = {
            getShareCounts: function (t, e) {
              if (e = e || function () {}, t) {
                var a = t.services || t.service || t,
                  n = t.url || t.countUrl,
                  i = n || (k.addthis_share || {}).trackurl || _ate.track.mgu({}.url || (k.addthis_share || {}).url, {
                    clean: 1,
                    defrag: 1
                  });
            ...
            utils: {
              isArray: function (t) {
                return "isArray" in Array ? Array.isArray(t) : "[object Array]" === Object.prototype.toString.call(t)
              }
            }
          };
        m()
...
/*
playback timings (ms):
  LoadShardBlock: 936.927 (3)
  PetaboxLoader3.datanode: 962.746 (4)
  CDXLines.iter: 32.899 (3)
  load_resource: 481.346
  esindex: 0.013
  RedisCDXSource: 105.603
  PetaboxLoader3.resolve: 275.176 (2)
  exclusion.robots.policy: 0.171
  captures_list: 1158.143
